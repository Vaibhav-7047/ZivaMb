  ...
  run: async (client, interaction) => {
    ...
    if (autoplay) {
      ...
      let thing = new EmbedBuilder()
        ...
        .setTimestamp()
        .setAuthor({name:`| Autoplay Is Now Disabled`, iconURL: interaction.member.displayAvatarURL({dynamic:true})});
      ...
      let thing = new EmbedBuilder()
        .setColor(client.embedColor)
        .setTimestamp()
        .setAuthor({name:`| Autoplay Is Now Enabled`, iconURL: interaction.member.displayAvatarURL({dynamic:true})});
